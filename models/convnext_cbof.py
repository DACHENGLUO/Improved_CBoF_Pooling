...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000, 
        ...
        self.cbof = Cos_BoF_Pooling(dims[-1],dims[-1])
...
@register_model
def convnext_tiny_cbof(pretrained=False, **kwargs):
...
@register_model
def convnext_small_cbof(pretrained=False, **kwargs):
...
@register_model
def convnext_base_cbof(pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_large_cbof(pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_xlarge_cbof(pretrained=False, in_22k=False, **kwargs):
